...
def showAuthorMsg(msg):
    ...
    time.sleep(2)
    input("\n    \033[92m[\033[37m*\033[92m] \033[37mPress Enter To Continue 𝐍𝐨𝐲𝐬𝐡𝐢𝐦 𝐁𝐨𝐦𝐦𝐞𝐫...")
    logo()
...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf NoyshimBomber && git clone https://github.com/Toxic-Noob/ToxicBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd NoyshimBomber && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Noyshim.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/noyshim504 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : HunterNS            \033[37mV4.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
